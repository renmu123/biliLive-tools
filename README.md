...
如果官方服务无法使用可以尝试使用公益服（由我搭建），稳定性无法保证
公益服：http://139.196.77.29:9999
...
1. 目前支持ffmepg任务和斗鱼视频下载最大任务数，可以在“设置-任务-ffmpeg最大任务数”中进行设置，默认为不限制
2. 手动暂停的任务不会被自动启动
3. 高能进度条任务会自动进行，因为速度会很快
...
`弹幕分析`功能依赖于sqlite3，如果你无法编译安装，尝试安装[visual-studio2022](https://visualstudio.microsoft.com/zh-hans/thank-you-downloading-visual-studio/?sku=Community)，以及python3(也许)。  
如果你是Win，你还可能遇到报错比如`cause=fork/exec %1 is not a valid Win32 application.`，根据[提示](https://github.com/pnpm/pnpm/issues/5638)修改pnpm源文件。  
