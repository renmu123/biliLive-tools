...
**接口地址:** `POST /video/douyu/videoList`

**请求参数:**

| 参数名 | 类型   | 必填 | 说明       |
| ------ | ------ | ---- | ---------- |
| subId  | string | 是   | 视频主页ID |

```js
[
  {
    startTime: 1780108026,
    title: "单机王中王",
    timeStr: "2026/5/30 10:27:06",
    videos: [
      {
        videoId: "1LDR7Q1p35V7Jzx8",
        title: "【2026-05-30 10点场】老皮历险记：单机王中王",
      },
    ],
  },
];
...
{
  "name": "异灵术老师",
  "subId": "3z97Jx5eydkY", // 用于查询视频列表的id
  "platform": "douyu",
  "enable": true,
  "roomId": "93589",
  "options": {
