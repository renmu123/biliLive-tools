...
## 1.0.0版本后nvnec转码无法正常使用

请尝试更新显卡驱动，如果更新到最新后还无法使用，请尝试手动更换ffmpeg可执行文件，或使用1.0.0以下版本
...
zip包并非传统意义上的绿色包，数据和安装包文件的会存放在同一个文件夹中，如果你尝试使用一种之后使用另外一种方式，可能会导致二进制文件的路径错误从而无法使用，请尝试在设置中手动修改二进制文件路径
